...
/** Try to create a deep clone of an Array or a standard clone of a scalar.
  ...
  */
   ...
   /** Allocate an array dynamically. The Array.newInstance method
	...
	/**
	 * Converts a Double arraylist to double[]
	 * @param array1D the arraylist in question
	 * @return the converted values from Double -> double.
	 */
	public static double[] convertDAL(ArrayList<Double> array1D){

		int i = 0;
		double[] retval = new double[array1D.size()];
