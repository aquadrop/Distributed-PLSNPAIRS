...
public class TestEndianCorrectOutputStream extends DataOutputStream {
     ...
     */
    public TestEndianCorrectOutputStream(String filename, boolean be) throws FileNotFoundException, SecurityException {
     ...
     * @exception FileNotFoundException
     */
    public TestEndianCorrectOutputStream(OutputStream os, boolean be)  {
	super(os);
	bigendian = be;
    }
