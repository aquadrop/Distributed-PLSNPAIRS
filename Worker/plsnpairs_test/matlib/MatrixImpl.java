...
//import jmatlink.*; MATLAB OPTION NOT AVAILABLE 
 ...
 *  
 *  Currently, MatrixImpl implements ColtMatrix, ParallelColtDoubleMatrix,
 *  ParallelColtFloatMatrix and MatlabMatrix.  
 *  
...
public class MatrixImpl {
	 ...
	 * 			Current implementation includes 'Matlab', 'Colt', 'ParallelColt',
	 * 			'ParallelColt (Float)'
	 * 
	 * @see matlib.MatlabMatrix
	 * @see matlib.ParallelColtDoubleMatrix
	 * @see matlib.ColtMatrix
	 * @see matlib.ParallelColtFloatMatrix
	 * @see matlib.Matrix
