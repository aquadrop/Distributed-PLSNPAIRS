...
public class CreateSessionProfile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean useAllVox = true;
		if (params.containsKey("USE_ALL_VOX") ) {
			useAllVox = Boolean.parseBoolean(request.getParameter("USE_ALL_VOX") );
		}
		...
		SessionProfile profile = new SessionProfile(description, datamatPrefix, mergeAcrossRuns, conditionInfo,
				runInfo, !brainMaskFile.equals(""), brainMaskFile, isNPAIRS, isBlock, numSkippedScans, ignoreRuns,useAllVox);
