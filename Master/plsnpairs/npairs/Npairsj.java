...
public class Npairsj{
	private static final long serialVersionUID = 4115818839571700694L;
...
/*	 Summary results:*/
	...
	public Npairsj(NpairsDataLoader dataLoader, NpairsjSetupParams nsp, String matlibType,int index) 
...
//			}
	...
	private void runFullDataAnalysis() throws NpairsjException, IOException {
		if (setupParams.initFeatSelect) {
			fullDataAnalysis = new Analysis(dataLoader.getFeatSelData(), setupParams,index);
		} 
		else fullDataAnalysis = new Analysis(dataLoader.getOrigData(), setupParams,index);
