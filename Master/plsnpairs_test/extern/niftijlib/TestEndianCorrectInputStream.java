...
public class TestEndianCorrectInputStream extends DataInputStream {
     ...
     */
    public TestEndianCorrectInputStream(String filename, boolean be) throws FileNotFoundException {
     ...
     * @exception FileNotFoundException
     */
    public TestEndianCorrectInputStream(InputStream is, boolean be)  {
	super(is);
	bigendian = be;
    }
